    ...
    if(isset($_SESSION["isLogin"]) && $_SESSION["isAdmin"] == "true"){
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if(!empty($_POST["title"]) && !empty($_POST["text"])){
                ...
                if (!in_array($file_ext, $allowed_extensions) || !in_array($file_type, ['image/jpeg', 'image/png', 'image/gif','image/webp']) || $file_error !== 0) {
                    ...
                    MessageFunc("Yazı eklendi","success","../index.php");
                }
            }
        }
    }else{
