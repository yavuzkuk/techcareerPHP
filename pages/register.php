        ...
        <div class="row h-100">
            ...
            <div class="col-8" style="height: 90%;">
                <form method="post">
                    <div>
                        <div class="col-12">
                            <label for="basic-url" class="form-label">Kullanıcı adı</label>
                            <input name="username" type="text" class="form-control" placeholder="kullanıcıadı" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-12 mt-1">
                            <label for="basic-url" class="form-label">E-mail</label>
                            <input name="email" type="email" class="form-control" placeholder="user@example.com" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-12 mt-1">
                            <label for="basic-url" class="form-label">Şifre </label>
                            <input name="passwd" type="password" class="form-control" placeholder="Şifre" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-12 mt-1">
                            <label for="basic-url" class="form-label">Şifre x2</label>
                            <input name="passwd2" type="password" class="form-control" placeholder="Şifre Tekrar" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div style="display: flex;flex-direction: row;align-items: center;" class="mt-3">
                        <button type="submit" href="" class="btn btn-outline-primary" style="margin-right: 10px;">Kayıt ol</button>
                    </div>
                    <div class="mt-3">
                    </div>
                </form>
            ...
            <div class="col" style="display:flex;justify-content: space-around;flex-direction: column;">
                <div>
                    <b>
                        Eğer hesabınız varsa <a href="login.php" class="links">buradan</a> giriş yapabilirsiniz.
                    </b>
                </div>
                <div>
